...
public class AlumnoService {
    ...
    public List<Map<String, Object>> Estudiantes(String codigo) {
    ...
    public Universitario registrarEstudiantes(Universitario bean) {
        Connection cn = null;
        try {
            cn = AccessDB.getConnecction();
            ...
            String clave = crearNuevaClaveEstudiante();
    ...
    public String ultimoCodigoEstudiante() {
        String codigo = "";
        Connection cn = null;
        try {
            cn = AccessDB.getConnecction();
    ...
    private String crearNuevoCodigoAlumno() {
        int codigo = Integer.parseInt(ultimoCodigoEstudiante().substring(1, 5));
        int proceso;
        String codigoCurso;
        if (codigo < 1000) {
            proceso = codigo + 1;
    ...
    public String crearNuevaClaveEstudiante() {
